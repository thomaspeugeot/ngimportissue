...
import (
	...
	ngimportissue_orm "ngimportissue/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*ngimportissue_orm.BackRepoStruct
}
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*ngimportissue_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *ngimportissue_orm.BackRepoStruct, stackPath string) {
