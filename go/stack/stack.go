...
import (
	...
	"ngimportissue/go/fullstack"
	"ngimportissue/go/models"
	"ngimportissue/go/orm"
	"ngimportissue/go/probe"

	ngimportissue_go "ngimportissue/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "ngimportissue/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, ngimportissue_go.GoModelsDir, ngimportissue_go.GoDiagramsDir,
