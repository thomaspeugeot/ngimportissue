module ngimportissue

go 1.21.1

require (
	github.com/fullstack-lang/gong v0.0.0-20231124124832-88fa12811a6d
	github.com/fullstack-lang/gongdoc v0.0.0-20231122074818-7e8146026213
